...
int MAESTRO = 2; //RELÉ IN4
int ESCLAVO_1 = 8; //ESCLAVO1 IN2
int ESCLAVO_2 = 9; //ESCLAVO2 IN1
int WAITTIME = 1000;
bool adelante = true;

//Variables para niveles de intensidad
int INTENSIDAD_LOW = 100;
int INTENSIDAD_MEDIUM = 110;
int INTENSIDAD_HIGH = 120;
...
// How many NeoPixels are attached to the Arduino? Orignalmente a 30
#define LED_COUNT 12
